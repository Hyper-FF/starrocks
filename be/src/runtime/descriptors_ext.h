...
public:
    explicit OlapTableDescriptor(const TTableDescriptor& tdesc,
                                 std::pmr::memory_resource* mr = std::pmr::get_default_resource());
...
public:
    explicit SchemaTableDescriptor(const TTableDescriptor& tdesc,
                                   std::pmr::memory_resource* mr = std::pmr::get_default_resource());
...
public:
    explicit BrokerTableDescriptor(const TTableDescriptor& tdesc,
                                   std::pmr::memory_resource* mr = std::pmr::get_default_resource());
...
public:
    explicit EsTableDescriptor(const TTableDescriptor& tdesc,
                               std::pmr::memory_resource* mr = std::pmr::get_default_resource());
...
public:
    explicit MySQLTableDescriptor(const TTableDescriptor& tdesc,
                                  std::pmr::memory_resource* mr = std::pmr::get_default_resource());
    std::string debug_string() const override;
...
public:
    explicit JDBCTableDescriptor(const TTableDescriptor& tdesc,
                                 std::pmr::memory_resource* mr = std::pmr::get_default_resource());
    std::string debug_string() const override;
