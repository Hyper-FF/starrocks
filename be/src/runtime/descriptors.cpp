...
SlotDescriptor::SlotDescriptor(SlotId id, std::string name, TypeDescriptor type, std::pmr::memory_resource* mr)
        : _id(id),
          _type(std::move(type)),
          _parent(0),
          _col_name(std::pmr::string(name, mr)),
          _col_unique_id(-1),
          _slot_idx(0),
...
SlotDescriptor::SlotDescriptor(const TSlotDescriptor& tdesc, std::pmr::memory_resource* mr)
        : _id(tdesc.id),
          ...
          _col_name(std::pmr::string(tdesc.colName, mr)),
          _col_unique_id(tdesc.col_unique_id),
          _col_physical_name(std::pmr::string(tdesc.col_physical_name, mr)),
...
SlotDescriptor::SlotDescriptor(const PSlotDescriptor& pdesc, std::pmr::memory_resource* mr)
        : _id(pdesc.id()),
          ...
          _col_name(std::pmr::string(pdesc.col_name(), mr)),
          _col_unique_id(-1),
...
TableDescriptor::TableDescriptor(const TTableDescriptor& tdesc, std::pmr::memory_resource* mr)
        : _name(std::pmr::string(tdesc.tableName, mr)), _database(std::pmr::string(tdesc.dbName, mr)), _id(tdesc.id) {}
...
DescriptorTbl::DescriptorTbl(std::pmr::memory_resource* mr)
        : _tbl_desc_map(mr), _tuple_desc_map(mr), _slot_desc_map(mr), _slot_with_column_name_map(mr) {}
