...
#define ADD_VARIANT_PHASE1_TYPE(LOGICAL_TYPE, VALUE)                                                     \
    ...
    ADD_VARIANT_PHASE1_TYPE(TYPE_BOOLEAN, uint8_t);
    ADD_VARIANT_PHASE1_TYPE(TYPE_TINYINT, int8_t);
    ADD_VARIANT_PHASE1_TYPE(TYPE_SMALLINT, int16_t);
    ADD_VARIANT_PHASE1_TYPE(TYPE_INT, int32_t);
    ADD_VARIANT_PHASE1_TYPE(TYPE_DECIMAL32, decimal32);
    ADD_VARIANT_PHASE1_TYPE(TYPE_BIGINT, int64_t);
