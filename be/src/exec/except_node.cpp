...
StatusOr<pipeline::OpFactories> ExceptNode::decompose_to_pipeline(pipeline::PipelineBuilderContext* context) {
    ...
    auto set_op_part_type = set_op_is_colocate ? TPartitionType::BUCKET_SHUFFLE_HASH_PARTITIONED
    ...
    context->subscribe_pipelines_since(probe_pipelines_begin, context->last_pipeline(),
