...
public class CreateFunctionAnalyzer {
    ...
    private static final String INPUT_TYPE_SCALAR = "scalar";
    private static final String INPUT_TYPE_ARROW = "arrow";
    ...
    private static String getAndCheckInputType(CreateFunctionStmt stmt) {
        String inputType = stmt.getProperties().getOrDefault(CreateFunctionStmt.INPUT_TYPE, INPUT_TYPE_SCALAR);
        if (!inputType.equalsIgnoreCase(INPUT_TYPE_ARROW) && !inputType.equalsIgnoreCase(INPUT_TYPE_SCALAR)) {
    ...
    private static boolean isArrowInput(String inputType) {
        return INPUT_TYPE_ARROW.equalsIgnoreCase(inputType);
    }
