...
struct TRuntimeFilterDescription {
  ...
  4: optional map<Types.TPlanNodeId, Exprs.TExpr> plan_node_id_to_target_expr (cpp.template = "std::unordered_map")
  ...
  15: optional map<Types.TPlanNodeId, list<Exprs.TExpr>> plan_node_id_to_partition_by_exprs (cpp.template = "std::unordered_map");
...
struct TRuntimeFilterParams {
  ...
  2: optional map<i32, list<TRuntimeFilterProberParams>> id_to_prober_params (cpp.template = "std::unordered_map")
  ...
  3: optional map<i32, i32> runtime_filter_builder_number (cpp.template = "std::unordered_map")
